...
ggsave(filename = "./Figure_Panels/EDFig.11j.left.pdf", width = 3.5, height = 5, useDingbats=FALSE)
...
b+ geom_boxplot(outlier.shape = NA)+
  ...
  theme(axis.text = element_text(colour = "black"))
ggsave(filename = "./Figure_Panels/EDFig.11j.middle.pdf", width = 3.5, height = 5, useDingbats=FALSE)
...
c+ geom_boxplot(outlier.shape = NA)+
  ...
  theme(legend.position= "none") +
  theme(axis.text = element_text(colour = "black"))
ggsave(filename = "./Figure_Panels/EDFig.11j.right.pdf", width = 3.5, height = 5, useDingbats=FALSE)