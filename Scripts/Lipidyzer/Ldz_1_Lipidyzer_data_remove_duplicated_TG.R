### Remove duplicated TG lipids in Lipidyzer data before class class sum concentration analysis
...
Dyzer.ClaFltr <- Dyzer.raw %>% #447 lipids
  ...
  mutate(., ID_string = case_when(
    Class %in% c("CE", "LPC", "LPE", "CER", "DCER", "HCER", "LCER", "FFA", "SM") ~ list(c(n.str[[1]][1], paste0(n.str[[1]][2],":", n.str[[1]][3]))),
...
save(Ldz.Qui.nodup, file = "./Output_Data/Lipidyzer_qNSC_dup_TG_removed.Rdata")
